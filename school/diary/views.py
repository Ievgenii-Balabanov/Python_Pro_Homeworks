...
def index(request):
    ...
    if request.POST:
        ...
        if form_data.is_valid():
            some_new_player = FootballPlayer.objects.create(
    ...
    data = {"form": form_data, "error": error}
...
def football_player(request):
    ...
    context = {"players": FootballPlayer.objects.all()}
...
def achievements(request):
    ...
    context_achievement = {"achievement_key": Achievement.objects.all()}
...
def achievements_detail(request, achievement_id):
    ...
    return render(
        request, "diary/achievements_detail.html", {"achievement_key": reaching}
    )
...
def add_achievement(request, football_player_id):
    ...
    if form_data.is_valid():
        Achievement.objects.create(
            football_player_achievements=new_player,
    ...
    return render(
        request,
        "diary/player.html",
        {"players": new_player, "error_message": form_data.errors},
    )
